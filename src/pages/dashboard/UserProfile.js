...
import { Profile, ProfileCover, ProfileGallery, ProfileFollowers } from '../../components/_dashboard/user/profile';
...
export default function UserProfile() {
  ...
  const { myProfile, output, gallery } = useSelector((state) => state.user);
  // const { user } = useAuth();
  ...
  const PROFILE_TABS = [
    ...
    },
    {
      ...
      component: <ProfileFollowers followers={output?.output} onToggleFollow={handleToggleFollow} />
    },
    // {
    //   value: 'friends',
  ...
  return (
    <Page title="User: Profile | Digibot">
