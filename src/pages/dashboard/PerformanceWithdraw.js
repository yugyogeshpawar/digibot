...
export default function MintingPayouts() {
  ...
  return (
    <Page title="Performance Withdraw - Digibot">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          heading="Performance Withdraw"
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.root },
            {
              name: 'Performance Withdraw',
        ...
        {!isComplete ? (
          <>
            {activeStep === 0 && (
              <PerfomancePayoutCart setWithdrawSummary={setWithdrawSummary} checkoutType="minting" />
            )}
            {activeStep === 1 && <CheckoutPoolConfirm withdrawSummary={withdrawSummary} checkoutType="minting" />}
          </>
        ) : (
