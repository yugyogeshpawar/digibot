...
import { getProduct, getProductFormServer } from '../../redux/slices/product';
// routes
...
export default function EcommerceProductDetails() {
  ...
  useEffect(() => {
    // dispatch(getProduct('jordan-delta'));
    dispatch(getProductFormServer(name));
  }, [dispatch, name]);
  ...
  return (
    <Page title="Ecommerce: Product Details | Digibot">
        ...
        <HeaderBreadcrumbs
          ...
          links={[
            { name: 'Dashboard', href: PATH_DASHBOARD.root },
            {
              ...
              href: PATH_DASHBOARD.nftMarket.shop
            },
