  ...
  return (
    <Page title="Ecommerce: Checkout | Digibot">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        {!isComplete ? (
          <>
            {activeStep === 0 && <PayoutCart setWithdrawSummary={setWithdrawSummary} checkoutType="reward" />}
            {activeStep === 1 && <CheckoutWalletConfirm withdrawSummary checkoutType="reward" />}
          </>
        ) : (
