...
export default function ReferralPayouts() {
  ...
  // how to initailize a property as function in an object
  ...
  return (
    <Page title="Ecommerce: Checkout | Digibot">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        {!isComplete ? (
          <>
            {activeStep === 0 && <PayoutCart setWithdrawSummary={setWithdrawSummary} checkoutType="reload" />}
            {activeStep === 1 && <CheckoutWalletConfirm withdrawSummary checkoutType="reload" />}
          </>
        ) : (
