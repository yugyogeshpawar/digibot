...
export default function AuraInvestment() {
  ...
  const columns = [
    ...
    { field: 'member_name', headerName: 'Member Name', width: 120, editable: true },
  ...
  return (
    <div style={{ height: '80vh', width: '100%' }}>
      ...
      <Dialog open={open2} onClose={handleClose2}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to approve the user with reference {selectedRow?.with_referrance} and user name {selectedRow?.member_name}
            and investment Amount {selectedRow?.gusdAmt}?
          </DialogContentText>
