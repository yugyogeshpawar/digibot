...
export default function CheckoutOrderComplete({ ...other }) {
  ...
  return (
    <DialogStyle fullScreen {...other} sx={{ width: 'auto', maxWidth: 600, marginX: 'auto' }}>
      <Box sx={{ p: 4, maxWidth: 480, margin: 'auto' }}>
        <Box sx={{ textAlign: 'center' }}>
          ...
          <Typography align="left">
            If you have any question or queries then fell to get in contact us. <br /> <br /> All the best,
          </Typography>
        </Box>
