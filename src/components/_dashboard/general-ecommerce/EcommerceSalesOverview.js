...
const MOCK_SALES = [...Array(3)].map((_, index) => ({
  ...
  positions: mockData.number.price(index) * 100,
  stone: mockData.number.price(index) * 100,
  ...
  return (
    <Stack spacing={1}>
      <Stack direction="row" alignItems="center">
        ...
        <Typography variant="subtitle2">{fCurrency(Number(progress.amount))}</Typography>
