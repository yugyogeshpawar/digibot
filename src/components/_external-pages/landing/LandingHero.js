          ...
          <ContentStyle>
            ...
            <motion.div variants={varFadeInRight}>
              <Typography sx={{ color: 'common.white' }}>
                Digibot is the first community-powered cryptocurrency, based on an unique referral/reward scheme in
                which NFTs can be staked and earn APY (Annual Percentage Yield).
              </Typography>
            </motion.div>
